...
public class Consultant extends AbstractEmployee {
    ...
    /**
     * This method calculates and sets average rating to consultant
     */
    public void setAverageRating(){
        ...
        if (feedbackFromCustomerList.isEmpty()){
            averageRating=0;
        }else {
            averageRating=Double.parseDouble(noCommaRating);
        }

    }

    /**
     * This method calculates and sets average rating to all consultants
     */
